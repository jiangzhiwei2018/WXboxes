...
App({
  ...
  getBaiduOpenApiToken: function (cb) {
    ...
    var url = 'https://wxapi.hotapp.cn/proxy/?appkey=hotapp11377340&url=https://openapi.baidu.com/oauth/2.0/token';
    wx.request({
      url: url,
      data: {
  ...
  getTulingMsg: function (info, cb) {
    var url = 'https://wxapi.hotapp.cn/proxy/?appkey=hotapp11377340&url=http://www.tuling123.com/openapi/api?key=eeec171e907553c15aa3131562f75903&info=' + info;
    wx.request({
      url: url,
      data: {
  ...
  globalData: {
    userInfo: null,
    requestUrl: "https://wxapi.hotapp.cn/proxy/?appkey=hotapp11377340&url=https://route.showapi.com/255-1",
    appid: "93837",
    apiKey: "ee4c9ea7518e48059fd76dc1fa382464",
    tText: '29',
    tImg: '10',
    tAudio: '31',
    tVideo: '41'
